...
const TransferSummaryCard = memo(function (props: TransferSummaryCardProps) {
  ...
  useEffect(() => {
    setShowReturnTrip(
      !!props.clientData?.return_data?.return_count ||!!props.clientData?.return_data?.return_date || !!props.clientData?.return_data?.return_hour )
  }, [props.clientData]);
      ...
      <div>
        <figure className="flex flex-col gap-2">
          ...
          <div>
            ...
            <div className="p-2 flex flex-col gap-1">
              <h3 className="font-bold">
                {props.clientData?.pickup_location?.name ?? ""}
              </h3>
            ...
            <div className="flex items-center gap-2">
              ...
              <p className="text-base">{props.clientData?.pickup_date ?? ""}</p>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
              ...
              <p className="text-base">{props.clientData?.pickup_hour ?? ""}</p>
            </div>
          </div>
          ...
          <div className="flex justify-between items-center">
            ...
            <p className="text-base">{`${props.totalDistanceKM} km`}</p>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width={24}
              height={24}
            ...
            <p className="text-base">{props.drivingDuration}</p>
          </div>
          <hr className=" text-gray w-full"></hr>
          ...
          {showReturnTrip == true && (
            <div id="return">
              ...
              <div className="flex items-center gap-2 mb-2">
                ...
                <p className="text-base">{returnDate}</p>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
                ...
                <p className="text-base">{returnHour}</p>
              </div>
              <div className="flex flex-col gap-2">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <p className="text-base">{`${returnPassengerCount} people`}</p>
                  {/* Destination Icon iconify */}
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 512 512"

      ...
      <div>
          <>
            ...
            <div className="flex flex-col">
              ...
              <p className="section-text font-bold">{clientData?.booking.transfer_type}</p>
            </div>
            <div className="divider my-1"></div>
            <div className="flex flex-col">
              <h2 className="title mb-1">VEHICLE</h2>
              <p className="section-text font-bold">{clientData?.booking.vehicle_name}</p>
            </div>
            <div className="divider my-1"></div>
            <div className="flex flex-col">
            ...
            {clientData?.extras &&
            Object.keys(clientData?.extras).length > 0 ? (
              <>
                <div className="divider my-1"></div>
                <div className="flex flex-col">
            ...
            <div className="flex gap-2 justify-between">
              <div className="flex flex-col w-1/2">
                ...
                <p className="section-text font-bold">{clientData?.booking.route_info.distanceKm.toFixed(0)} km</p>
                <div className="divider my-1"></div>
              </div>
              <div className="flex w-1/2 flex-col">
                <h2 className="title mb-1">TOTAL TIME</h2>
                <p className="section-text font-bold">{clientData?.booking.route_info.durationHours} h {clientData?.booking.route_info.durationMinutes} min</p>
                <div className="divider my-1"></div>
              </div>
            </div>
